# coding: utf-8
from db import Collection, Gingko, Item, get_items, get_collections, get_attach, get_attach_by_key, get_col_key, get_attach_key, get_item_key
...
def get_attach_key(attach_name: str) -> None:
    for attach_key in get_attach_key(attach_name=attach_name):
        print(attach_key)

@app.command(help='Get item key')
def get_item_key(attach_key: str, item_key: str) -> None:
    for item_key in get_item_key(attach_key=attach_key, item_key=item_key):
        print(item_key)
